...
s9 = Stat.create score: 24, average_time: 3.9, accuracy: 31, level: 1, user: u1, game: g3, created_at: Date.today - 6.days
s10 = Stat.create score: 46, average_time: 4.1, accuracy: 27, level: 1, user: u1, game: g3, created_at: Date.today - 5.days
s11 = Stat.create score: 38, average_time: 10.3, accuracy: 41, level: 1, user: u1, game: g3, created_at: Date.today - 4.days
s12 = Stat.create score: 28, average_time: 9.3, accuracy: 59, level: 1, user: u1, game: g3, created_at: Date.today - 3.days
s13 = Stat.create score: 39, average_time: 7.2, accuracy: 63, level: 1, user: u1, game: g3, created_at: Date.today - 2.days
s14 = Stat.create score: 26, average_time: 4.8, accuracy: 76, level: 1, user: u1, game: g3, created_at: Date.today - 1.days

s15 = Stat.create score: 24, average_time: 7.1, accuracy: 32, level: 1, user: u1, game: g4, created_at: Date.today - 7.days
s16 = Stat.create score: 35, average_time: 9.5, accuracy: 42, level: 1, user: u1, game: g4, created_at: Date.today - 6.days
s17 = Stat.create score: 18, average_time: 11.2, accuracy: 40, level: 1, user: u1, game: g4, created_at: Date.today - 5.days
s18 = Stat.create score: 25, average_time: 4.4, accuracy: 52, level: 1, user: u1, game: g4, created_at: Date.today - 4.days
s19 = Stat.create score: 38, average_time: 6.8, accuracy: 49, level: 1, user: u1, game: g4, created_at: Date.today - 3.days
s20 = Stat.create score: 44, average_time: 7.5, accuracy: 63, level: 1, user: u1, game: g4, created_at: Date.today - 2.days
s21 = Stat.create score: 31, average_time: 13.2, accuracy: 88, level: 1, user: u1, game: g4, created_at: Date.today - 1.days
