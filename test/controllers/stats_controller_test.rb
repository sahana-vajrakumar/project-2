...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { accuracy: @stat.accuracy, average_time: @stat.average_time, game_id: @stat.game_id, score: @stat.score, user_id: @stat.user_id } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { accuracy: @stat.accuracy, average_time: @stat.average_time, game_id: @stat.game_id, score: @stat.score, user_id: @stat.user_id } }
